Este Proyecyo se basa en la cracion de Un repositorio publico donde se tendra commit junto asu mensaje acompañado del ejemplo de un push en el repositorio local.
